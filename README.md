...
- **Черновики**: написание и переписывание постов с учетом tone of voice.
- **Tone of voice**: генерация стиля из последних постов или ручная настройка.
...
- **YouTube-идеи**: получение публичных субтитров через `youtube-transcript-api`.
- **Контент-план**: планирование публикаций и автоматический постинг.
